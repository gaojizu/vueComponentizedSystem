const commponents = {
  ...
  data: {
    components: [
      ...
      {name: '文本复制', prop: 'copy', introduce: '一键复制文本'},
      ...
      {name: '导出xlsx文件', prop: 'exportExcel', introduce: '导出后端返回的数据table为exel文件'},
      {name: '数组排序', prop: 'sort', introduce: '数组根据属性进行排序，根据sting字段进行升序和降序'},
